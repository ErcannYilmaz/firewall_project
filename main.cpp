...
const int size_of_buffer = 50;
int current_index = 0;
int index_of_writing = 0;

// Files to write captured data's
char files_to_write[5][51] = {  "/home/grazol/project/csvfiles/network_traffic1.csv", 
                                "/home/grazol/project/csvfiles/network_traffic2.csv", 
                                "/home/grazol/project/csvfiles/network_traffic3.csv",
                                "/home/grazol/project/csvfiles/network_traffic4.csv", 
                                "/home/grazol/project/csvfiles/network_traffic5.csv" };
...
{
    packet_stats stats2;
    if (index_of_writing > size_of_buffer - 1)
    {
        index_of_writing = 0;
    }
    if(current_index > size_of_buffer - 1)
    {
    ...
    cout << "\nSource IP:" << stats2.src_ip <<
        ...
        "\nPacket Count:" << stats2.packetcount <<
...
int main(int argc, char* argv[])
{
    ...
    device = open_interface("wlxc006c3487445", device);
